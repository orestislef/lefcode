import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@lefcode/sdk/v2"
import { SessionTurn } from "@lefcode/ui/session-turn"
import { SessionReview } from "@lefcode/ui/session-review"
import { DataProvider } from "@lefcode/ui/context"
import { DiffComponentProvider } from "@lefcode/ui/context/diff"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@lefcode/ui/logo"
import { IconButton } from "@lefcode/ui/icon-button"
import { ProviderIcon } from "@lefcode/ui/provider-icon"
import { createDefaultOptions } from "@lefcode/ui/pierre"
import { iife } from "@lefcode/util/iife"
import { Binary } from "@lefcode/util/binary"
import { NamedError } from "@lefcode/util/error"
import { DateTime } from "luxon"
import { SessionMessageRail } from "@lefcode/ui/session-message-rail"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@lefcode/ui/tabs"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/precision-diffs/ssr"
import { Diff as SSRDiff } from "@lefcode/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@lefcode/ui/icons/provider"
import { Meta } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@lefcode/ui/diff").then((m) => ({ default: m.Diff })))
